...
/*Supervisor*/
import AdminSupervisor from "./components/supervisor/AdminSupervisor";
import Supervisor from "./components/supervisor/Supervisor";
import UpdateSupervisor from "./components/supervisor/UpdateSupervisor";
import ViewSupervisor from "./components/Views/ViewSupervisor";
        ...
        <div className="home__actions">
          {courses.length > 0 ? (
            <>
              ...
              <div className="home__action">
                <Link to="/create-student">
                  <button>Request supervisor/Co supervisor</button>
                </Link>
              </div>
              <div className="home__manager">
                <Link to="/students">Manage Students</Link>
                <Link to="/classes">Manage Groups</Link>
                <Link to="/courses">Manage Topics</Link>
              </div>
            </>
          ) : (
            <div>
    ...
    <Provider store={store}>
      <Router>
        <Switch>
          ...
          <Route path="/create-student" exact component={AdminSupervisor} />
